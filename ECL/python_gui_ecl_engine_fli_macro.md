# Python GUI for ECL Engine Using FLI and Macroeconomic Factors

## Overview
This project creates a desktop GUI application in Python that:

1. Accepts Forward Looking Information (FLI) factors.
2. Accepts macroeconomic variables.
3. Builds an Expected Credit Loss (ECL) engine.
4. Calculates:
...
| CustomerID | Income | LoanAmount | CreditScore | LGD | EAD | DefaultFlag |
|---|---|---|---|---|---|---|
| 1 | 50000 | 20000 | 700 | 0.45 | 20000 | 0 |
| 2 | 30000 | 15000 | 620 | 0.55 | 15000 | 1 |
...
# How Macroeconomic Factors Affect ECL

The model adjusts PD using:
...
```python
adjusted_pd = pd * macro_factor * fli_multiplier
```
...
1. IFRS 9 staging logic
2. TTC vs PIT PD calibration
3. Multiple macroeconomic scenarios
4. Monte Carlo simulation
5. Stress testing framework
6. Survival analysis models
7. XGBoost / LightGBM PD models
...
# Enterprise Architecture Suggestion
...
For a production-grade implementation, include:
...
# Example Enhancements for Production
...
```python
# Lifetime ECL
lifetime_ecl = sum(discounted_future_losses)
```
